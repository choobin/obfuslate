...
main(){L(24);o=L(8);L(24);L(24);if(o&4)L(L(8)|L(8)<<8);if(o&8)w(L(8));if(o&16)w(L(8));if(o&2)L(16);w(!f){f=L(1);l=L(2);e=L(5)+257;d=L(5)+1;k=L(4)+4;i=0;w(i<k)h[i++[I]-97]=L(3);w(i<19)h[i++[I]-97]=0;T(u,h,19);i=0;w(i<e+d){o=A(u);k=3;n=2;c=0;if(o<16){h[i++]=o;continue;}if(o==16)c=h[i-1];if(o==17)n++;if(o>17){k=11;n=7;}k+=L(n);j=0;w(j++<k)h[i++]=c;}T(u,h,e);T(v,h+e,d);w(1){o=A(u);if(o<256){F(o)continue;}if(o==256)break;o-=257;if(o<9)e=o+3;else if(o==28)e=258;else{i=1;j=13;w(o>=j){j+=4;i++;}e=(1<<(i-1))*10+3+(o-j+4)*(1<<i);}n=0;if(o>7&&o<28)n=(o-4)/4;if(n>0)e+=L(n);o=A(v);n=0;if(o<4)d=o+1;else{n=(o>>1)-1;d=(1<<(n+1))+1+((o&1)<<n);}if(n>0)d+=L(n);E(e,d);}}N()}
